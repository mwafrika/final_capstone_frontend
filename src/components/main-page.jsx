    ...
    <div className="App grid grid-cols-6 w-full ">
      <div className="grid grid-rows-8 bg-gray-100">
        <div className="row-span-2 flex justify-center">
          <img className="self-center" src={`${process.env.PUBLIC_URL}/assets/images/logo_transparent.png`} alt="Logo" />
        </div>
      ...
      <div className="col-span-3 grid grid-rows-8">
        <img className="row-span-6 self-center justify-self-center" src={`${process.env.PUBLIC_URL}/assets/images/bike.png`} alt="bike" />
      ...
      <div className="col-span-2 flex flex-col justify-center mr-5">
        ...
        <div className="flex flex-col items-end pr-3 mt-5">
          ...
          <img src={`${process.env.PUBLIC_URL}/assets/images/color-picker.jpeg`} alt="color picker" className="w-3/4" />
        </div>
